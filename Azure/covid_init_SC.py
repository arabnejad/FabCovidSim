...
work_dir = '/home/wouter/VECMA/Campaigns_azure'
# work_dir = '/tmp'
config = 'Azure'
...
params = json.load(open(home + '/../templates_azure/params.json'))

directory_tree = {'param_files': None}
multiencoder_p_PC_CI_HQ_SD = uq.encoders.MultiEncoder(
    uq.encoders.DirectoryBuilder(tree=directory_tree),
    uq.encoders.GenericEncoder(         
        template_fname=home + '/../templates_azure/p_PC_CI_HQ_SD.txt',
        delimiter='$',
        target_filename='param_files/p_PC_CI_HQ_SD.txt'),
    uq.encoders.GenericEncoder(
        template_fname=home + '/../templates_azure/preUK_R0=2.0.txt',
        delimiter='$',
...
sampler = uq.sampling.SCSampler(vary=vary, polynomial_order=4,
                                quadrature_rule="C",
                                sparse=True, growth=True, midpoint_level1=True)
