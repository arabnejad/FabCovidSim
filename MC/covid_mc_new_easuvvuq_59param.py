...
WORK_DIR = '/home/wouter/VECMA/Campaigns/DAS_59'
# WORK_DIR = '/tmp'
# FabSim3 config name 
...
if INIT:
    ...
    params['Param_1_of_place_group_size_distribution0']['type'] = 'integer'
    params['Param_1_of_place_group_size_distribution1']['type'] = 'integer'
    params['Param_1_of_place_group_size_distribution2']['type'] = 'integer'
    params['Param_1_of_place_group_size_distribution3']['type'] = 'integer'
